...
static class Debbie {
    ...
    public static void ApplyCommand() {
        if (Materials.ByID.Contains(_commandInput)) {
    ...
    public static void Draw() {
        ...
        if (ShowCommandPrompt && ImGui.Begin("Material Search", ImGuiWindowFlags.NoTitleBar | ImGuiWindowFlags.AlwaysAutoResize| ImGuiWindowFlags.NoMove | ImGuiWindowFlags.NoCollapse | ImGuiWindowFlags.NoScrollbar)) {
